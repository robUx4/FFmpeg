...
typedef enum {
  MATROSKA_CHAPPROCESSTIME_DURING_THE_WHOLE_CHAPTER = 0,
  MATROSKA_CHAPPROCESSTIME_BEFORE_STARTING_PLAYBACK = 1,
  MATROSKA_CHAPPROCESSTIME_AFTER_PLAYBACK_OF_THE_CHAPTER = 2,
} MatroskaChapProcessTime;
...
typedef enum {
  MATROSKA_TARGETTYPEVALUE_COLLECTION       = 70,
  MATROSKA_TARGETTYPEVALUE_EDITION          = 60,
  MATROSKA_TARGETTYPEVALUE_ALBUM            = 50,
  MATROSKA_TARGETTYPEVALUE_PART             = 40,
  MATROSKA_TARGETTYPEVALUE_TRACK            = 30,
  MATROSKA_TARGETTYPEVALUE_SUBTRACK         = 20,
  MATROSKA_TARGETTYPEVALUE_SHOT             = 10,
...
typedef enum {
  MATROSKA_CONTENTENCODINGSCOPE_ALL_FRAME_CONTENTS = 1,
  MATROSKA_CONTENTENCODINGSCOPE_PRIVATE_DATA     = 2,
  MATROSKA_CONTENTENCODINGSCOPE_NEXT_CONTENTENCODING = 4,
...
typedef enum {
  ...
  MATROSKA_CONTENTENCALGO_DES_FIPS_46_3    = 1,
  MATROSKA_CONTENTENCALGO_TRIPLE_DES_RFC_1851 = 2,
  MATROSKA_CONTENTENCALGO_TWOFISH          = 3,
  MATROSKA_CONTENTENCALGO_BLOWFISH         = 4,
  MATROSKA_CONTENTENCALGO_AES_FIPS_187     = 5,
} MatroskaContentEncAlgo;

typedef enum {
  MATROSKA_CONTENTSIGALGO_NOT_SIGNED       = 0,
  MATROSKA_CONTENTSIGALGO_RSA              = 1,
} MatroskaContentSigAlgo;
...
typedef enum {
  MATROSKA_COLOUR_MATRIXCOEFFICIENTS_IDENTITY         = 0,
  MATROSKA_COLOUR_MATRIXCOEFFICIENTS_ITU_R_BT_709     = 1,
  MATROSKA_COLOUR_MATRIXCOEFFICIENTS_UNDETERMINED     = 2,
  MATROSKA_COLOUR_MATRIXCOEFFICIENTS_RESERVED         = 3,
  MATROSKA_COLOUR_MATRIXCOEFFICIENTS_US_FCC_73_682    = 4,
  MATROSKA_COLOUR_MATRIXCOEFFICIENTS_ITU_R_BT_470BG   = 5,
  MATROSKA_COLOUR_MATRIXCOEFFICIENTS_SMPTE_170M       = 6,
  MATROSKA_COLOUR_MATRIXCOEFFICIENTS_SMPTE_240M       = 7,
  MATROSKA_COLOUR_MATRIXCOEFFICIENTS_YCOCG            = 8,
  MATROSKA_COLOUR_MATRIXCOEFFICIENTS_BT2020_NON_CONSTANT_LUMINANCE = 9,
  MATROSKA_COLOUR_MATRIXCOEFFICIENTS_BT2020_CONSTANT_LUMINANCE = 10,
  MATROSKA_COLOUR_MATRIXCOEFFICIENTS_SMPTE_ST_2085    = 11,
  MATROSKA_COLOUR_MATRIXCOEFFICIENTS_CHROMA_DERIVED_NON_CONSTANT_LUMINANCE = 12,
  MATROSKA_COLOUR_MATRIXCOEFFICIENTS_CHROMA_DERIVED_CONSTANT_LUMINANCE = 13,
  MATROSKA_COLOUR_MATRIXCOEFFICIENTS_ITU_R_BT_2100_0  = 14,
...
typedef enum {
  MATROSKA_COLOUR_RANGE_UNDETERMINED     = 0,
  MATROSKA_COLOUR_RANGE_BROADCAST_RANGE  = 1,
  MATROSKA_COLOUR_RANGE_FULL_RANGE       = 2,
  MATROSKA_COLOUR_RANGE_DEFINED_BY_MATRIXCOEFFICIENTS = 3,
} MatroskaVideoRange;

typedef enum {
  MATROSKA_COLOUR_TRANSFERCHARACTERISTICS_RESERVED         = 0,
  MATROSKA_COLOUR_TRANSFERCHARACTERISTICS_ITU_R_BT_709     = 1,
  MATROSKA_COLOUR_TRANSFERCHARACTERISTICS_UNDETERMINED     = 2,
  MATROSKA_COLOUR_TRANSFERCHARACTERISTICS_RESERVED         = 3,
  MATROSKA_COLOUR_TRANSFERCHARACTERISTICS_GAMMA_2_2_CURVE_BT_470M = 4,
  MATROSKA_COLOUR_TRANSFERCHARACTERISTICS_GAMMA_2_8_CURVE_BT_470BG = 5,
  MATROSKA_COLOUR_TRANSFERCHARACTERISTICS_SMPTE_170M       = 6,
  MATROSKA_COLOUR_TRANSFERCHARACTERISTICS_SMPTE_240M       = 7,
  MATROSKA_COLOUR_TRANSFERCHARACTERISTICS_LINEAR           = 8,
  MATROSKA_COLOUR_TRANSFERCHARACTERISTICS_LOG              = 9,
  MATROSKA_COLOUR_TRANSFERCHARACTERISTICS_LOG_SQRT         = 10,
  MATROSKA_COLOUR_TRANSFERCHARACTERISTICS_IEC_61966_2_4    = 11,
  MATROSKA_COLOUR_TRANSFERCHARACTERISTICS_ITU_R_BT_1361_EXTENDED_COLOUR_GAMUT = 12,
  MATROSKA_COLOUR_TRANSFERCHARACTERISTICS_IEC_61966_2_1    = 13,
  MATROSKA_COLOUR_TRANSFERCHARACTERISTICS_ITU_R_BT_2020_10_BIT = 14,
  MATROSKA_COLOUR_TRANSFERCHARACTERISTICS_ITU_R_BT_2020_12_BIT = 15,
  MATROSKA_COLOUR_TRANSFERCHARACTERISTICS_ITU_R_BT_2100_PERCEPTUAL_QUANTIZATION = 16,
  MATROSKA_COLOUR_TRANSFERCHARACTERISTICS_SMPTE_ST_428_1   = 17,
  MATROSKA_COLOUR_TRANSFERCHARACTERISTICS_ARIB_STD_B67     = 18,
} MatroskaVideoTransferCharacteristics;

typedef enum {
  MATROSKA_COLOUR_PRIMARIES_RESERVED         = 0,
  MATROSKA_COLOUR_PRIMARIES_ITU_R_BT_709     = 1,
  MATROSKA_COLOUR_PRIMARIES_UNDETERMINED     = 2,
  MATROSKA_COLOUR_PRIMARIES_RESERVED         = 3,
  MATROSKA_COLOUR_PRIMARIES_ITU_R_BT_470M    = 4,
  MATROSKA_COLOUR_PRIMARIES_ITU_R_BT_470BG_BT_601_625 = 5,
  MATROSKA_COLOUR_PRIMARIES_ITU_R_BT_601_525_SMPTE_170M = 6,
  MATROSKA_COLOUR_PRIMARIES_SMPTE_240M       = 7,
  MATROSKA_COLOUR_PRIMARIES_FILM             = 8,
  MATROSKA_COLOUR_PRIMARIES_ITU_R_BT_2020    = 9,
  MATROSKA_COLOUR_PRIMARIES_SMPTE_ST_428_1   = 10,
  MATROSKA_COLOUR_PRIMARIES_SMPTE_RP_432_2   = 11,
  MATROSKA_COLOUR_PRIMARIES_SMPTE_EG_432_2   = 12,
  MATROSKA_COLOUR_PRIMARIES_EBU_TECH3213_E_JEDEC_P22_PHOSPHORS = 22,
